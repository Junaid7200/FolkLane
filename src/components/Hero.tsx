...
export default function Hero() {
  return (
    <section className="bg-gradient-to-br from-amber-50 via-orange-50 to-red-50 py-12 sm:py-16 md:py-20">
      <div className="container mx-auto px-4 sm:px-6 text-center">
        ...
        <Link
          ...
          className="inline-block w-full sm:w-auto text-center bg-amber-600 text-white px-8 sm:px-10 py-3 sm:py-4 rounded-full text-base sm:text-lg font-semibold hover:bg-amber-700 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
        >
          Browse Collections
        </Link>
      </div>
