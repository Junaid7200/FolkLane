...
const BRAND_ID = 'saima'
const BASE_URL = 'https://www.saimascollection.com'
...
async function fetchCollectionPageProducts(
  ...
  try {
    ...
    throw new Error(`Unable to fetch Saima collection page ${page}`)
  }
}
...
export async function scrapeSaima(
  opts: ScrapeOptions,
